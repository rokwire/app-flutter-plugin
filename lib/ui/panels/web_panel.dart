  ...
  Widget buildStatus(BuildContext context, {String? title, String? message}) {
    ...
    if (title != null) {
      contentList.add(flutter_html.Html(data: title,
          ...
          style: { "body": flutter_html.Style(color: Styles().colors!.fillColorPrimary, fontFamily: Styles().fontFamilies!.bold, fontSize: flutter_html.FontSize(32), textAlign: TextAlign.center, padding: EdgeInsets.zero, margin: flutter_html.Margins.zero), },),
      );
    }
    ...
    if ((message != null)) {
      contentList.add(flutter_html.Html(data: message,
        onLinkTap: (url, context, element) => onTapStatusLink(url),
        style: { "body": flutter_html.Style(color: Styles().colors!.fillColorPrimary, fontFamily: Styles().fontFamilies!.regular, fontSize: flutter_html.FontSize(20), textAlign: TextAlign.left, padding: EdgeInsets.zero, margin: flutter_html.Margins.zero), },),
      );
    }
