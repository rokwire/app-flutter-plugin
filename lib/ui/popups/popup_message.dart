...
class ActionsMessage extends StatelessWidget {
  ...
  @protected Widget? get defaultCloseButtonIcon => Styles().images?.getImage('close-white', defaultSpec: FontAwesomeImageSpec(type: 'fa.icon', source: '0xf057', size: 18.0, color: Styles().colors?.surface));
