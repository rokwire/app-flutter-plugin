...
extension Auh2Directory on Auth2 {
    ...
    for (String familyName in familyNames) {
      for (String firstName in firstNames) {
        ...
        result.add(Auth2PublicAccount(
          ...
          identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: '$lowerFirstName@illinois.edu')]
        ));
        id += 1;
  ...
  List<Auth2PublicAccount> get _sampleAccounts {
    ...
    List<Auth2PublicAccount> sampleAccounts = [
      Auth2PublicAccount(id:  '1', profile: Auth2UserProfile(id:  '1', firstName: 'James',      lastName: 'Smith',     pronunciationUrl: pronunciationUrl, pronouns: 'he',  photoUrl: manPhotos[0],   website: 'linkedin.com/james',    data: {'college': 'Academic Affairs', 'department': 'Campus Honors Program'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'james@illinois.edu',)]),
      Auth2PublicAccount(id:  '2', profile: Auth2UserProfile(id:  '2', firstName: 'Mary',       lastName: 'Johnson',   pronunciationUrl: pronunciationUrl, pronouns: 'she', photoUrl: womanPhotos[0], website: 'linkedin.com/mary',     data: {'college': 'Chancellor',       'department': 'Academic Human Resources'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'mary@illinois.edu', )]),
      Auth2PublicAccount(id:  '3', profile: Auth2UserProfile(id:  '3', firstName: 'Michael',    lastName: 'Williams',  pronunciationUrl: pronunciationUrl, pronouns: 'he',  photoUrl: manPhotos[1],   website: 'linkedin.com/michael',  data: {'college': 'Armed Forces',     'department': 'Air Force Aerospace Studies'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'michael@illinois.edu')]),
      Auth2PublicAccount(id:  '4', profile: Auth2UserProfile(id:  '4', firstName: 'Patricia',   lastName: 'Brown',     pronunciationUrl: pronunciationUrl, pronouns: 'she', photoUrl: womanPhotos[1], website: 'linkedin.com/patricia', data: {'college': 'Education',        'department': 'Curriculum and Instruction'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'patricia@illinois.edu')]),
      Auth2PublicAccount(id:  '5', profile: Auth2UserProfile(id:  '5', firstName: 'Robert',     lastName: 'Jones',     pronunciationUrl: pronunciationUrl, pronouns: 'he',  photoUrl: manPhotos[2],   website: 'linkedin.com/robert',   data: {'college': 'Law',              'department': 'Law Library'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'robert@illinois.edu')]),
      Auth2PublicAccount(id:  '6', profile: Auth2UserProfile(id:  '6', firstName: 'Jennifer',   lastName: 'Garcia',    pronunciationUrl: pronunciationUrl, pronouns: 'she', photoUrl: womanPhotos[2], website: 'linkedin.com/jennifer', data: {'college': 'Academic Affairs', 'department': 'Office of the Registrar'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'jennifer@illinois.edu')]),
      Auth2PublicAccount(id:  '7', profile: Auth2UserProfile(id:  '7', firstName: 'John',       lastName: 'Miller',    pronunciationUrl: pronunciationUrl, pronouns: 'he',  photoUrl: manPhotos[3],   website: 'linkedin.com/john',     data: {'college': 'Public Safety',    'department': 'Fire Service Institute'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'john@illinois.edu', )]),
      Auth2PublicAccount(id:  '8', profile: Auth2UserProfile(id:  '8', firstName: 'Linda',      lastName: 'Davis',     pronunciationUrl: pronunciationUrl, pronouns: 'she', photoUrl: womanPhotos[3], website: 'linkedin.com/linda',    data: {'college': 'Chancellor',       'department': 'Illinois Human Resources'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'linda@illinois.edu',)]),
      Auth2PublicAccount(id:  '9', profile: Auth2UserProfile(id:  '9', firstName: 'David',      lastName: 'Rodriguez', pronunciationUrl: pronunciationUrl, pronouns: 'he',  photoUrl: manPhotos[4],   website: 'linkedin.com/david',    data: {'college': 'Education',        'department': 'Education Administration'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'david@illinois.edu',)]),
      Auth2PublicAccount(id: '10', profile: Auth2UserProfile(id: '10', firstName: 'Elizabeth',  lastName: 'Martinez',  pronunciationUrl: pronunciationUrl, pronouns: 'she', photoUrl: womanPhotos[4], website: 'linkedin.com/lizbeth',  data: {'college': 'Armed Forces',     'department': 'Military Science'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'lizbeth@illinois.edu')]),
      Auth2PublicAccount(id: '11', profile: Auth2UserProfile(id: '11', firstName: 'William',    lastName: 'Hernandez', pronunciationUrl: pronunciationUrl, pronouns: 'he',  photoUrl: manPhotos[0],   website: 'linkedin.com/william',  data: {'college': 'Law',              'department': 'Law'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'william@illinois.edu')]),
      Auth2PublicAccount(id: '12', profile: Auth2UserProfile(id: '12', firstName: 'Barbara',    lastName: 'Lopez',     pronunciationUrl: pronunciationUrl, pronouns: 'she', photoUrl: womanPhotos[0], website: 'linkedin.com/barbara',  data: {'college': 'Public Safety',    'department': 'Police Training Institute'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'barbara@illinois.edu')]),
      Auth2PublicAccount(id: '13', profile: Auth2UserProfile(id: '13', firstName: 'Richard',    lastName: 'Gonzalez',  pronunciationUrl: pronunciationUrl, pronouns: 'he',  photoUrl: manPhotos[1],   website: 'linkedin.com/richard',  data: {'college': 'Academic Affairs', 'department': 'Campus Honors Program'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'richard@illinois.edu')]),
      Auth2PublicAccount(id: '14', profile: Auth2UserProfile(id: '14', firstName: 'Susan',      lastName: 'Wilson',    pronunciationUrl: pronunciationUrl, pronouns: 'she', photoUrl: womanPhotos[1], website: 'linkedin.com/susan',    data: {'college': 'Student Affairs',  'department': 'Counseling Center'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'susan@illinois.edu',)]),
      Auth2PublicAccount(id: '15', profile: Auth2UserProfile(id: '15', firstName: 'Joseph',     lastName: 'Anderson',  pronunciationUrl: pronunciationUrl, pronouns: 'he',  photoUrl: manPhotos[2],   website: 'linkedin.com/joseph',   data: {'college': 'Chancellor',       'department': 'Academic Human Resources'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'joseph@illinois.edu')]),
      Auth2PublicAccount(id: '16', profile: Auth2UserProfile(id: '16', firstName: 'Jessica',    lastName: 'Thomas',    pronunciationUrl: pronunciationUrl, pronouns: 'she', photoUrl: womanPhotos[2], website: 'linkedin.com/jessica',  data: {'college': 'Education',        'department': 'Special Education'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'jessica@illinois.edu')]),
      Auth2PublicAccount(id: '17', profile: Auth2UserProfile(id: '17', firstName: 'Thomas',     lastName: 'Taylor',    pronunciationUrl: pronunciationUrl, pronouns: 'he',  photoUrl: manPhotos[3],   website: 'linkedin.com/thomas',   data: {'college': 'Armed Forces',     'department': 'Naval Science'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'thomas@illinois.edu')]),
      Auth2PublicAccount(id: '18', profile: Auth2UserProfile(id: '18', firstName: 'Karen',      lastName: 'Moore',     pronunciationUrl: pronunciationUrl, pronouns: 'she', photoUrl: womanPhotos[3], website: 'linkedin.com/karen',    data: {'college': 'Public Safety',    'department': 'Fire Service Institute'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'karen@illinois.edu',)]),
      Auth2PublicAccount(id: '19', profile: Auth2UserProfile(id: '19', firstName: 'Christopher',lastName: 'Jackson',   pronunciationUrl: pronunciationUrl, pronouns: 'he',  photoUrl: manPhotos[3],   website: 'linkedin.com/christ',   data: {'college': 'Law',              'department': 'Law Library'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'christ@illinois.edu')]),
      Auth2PublicAccount(id: '20', profile: Auth2UserProfile(id: '20', firstName: 'Sarah',      lastName: 'Martin',    pronunciationUrl: pronunciationUrl, pronouns: 'she', photoUrl: womanPhotos[4], website: 'linkedin.com/sarah',    data: {'college': 'Education',        'department': 'Curriculum and Instruction'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'sarah@illinois.edu',)]),
      Auth2PublicAccount(id: '21', profile: Auth2UserProfile(id: '21', firstName: 'Charles',    lastName: 'Lee',       pronunciationUrl: pronunciationUrl, pronouns: 'he',  photoUrl: manPhotos[0],   website: 'linkedin.com/charles',  data: {'college': 'Academic Affairs', 'department': 'Principal\'s Scholars Pgm'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'charles@illinois.edu')]),
      Auth2PublicAccount(id: '22', profile: Auth2UserProfile(id: '22', firstName: 'Lisa',       lastName: 'Perez',     pronunciationUrl: pronunciationUrl, pronouns: 'she', photoUrl: womanPhotos[0], website: 'linkedin.com/lisa',     data: {'college': 'Chancellor',       'department': 'Illinois Human Resources'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'lisa@illinois.edu', )]),
      Auth2PublicAccount(id: '23', profile: Auth2UserProfile(id: '23', firstName: 'Daniel',     lastName: 'Thompson',  pronunciationUrl: pronunciationUrl, pronouns: 'he',  photoUrl: manPhotos[1],   website: 'linkedin.com/daniel',   data: {'college': 'Law',              'department': 'Law'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'daniel@illinois.edu')]),
      Auth2PublicAccount(id: '24', profile: Auth2UserProfile(id: '24', firstName: 'Nancy',      lastName: 'White',     pronunciationUrl: pronunciationUrl, pronouns: 'she', photoUrl: womanPhotos[1], website: 'linkedin.com/nancy',    data: {'college': 'Armed Forces',     'department': 'Military Science'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'nancy@illinois.edu',)]),
      Auth2PublicAccount(id: '25', profile: Auth2UserProfile(id: '25', firstName: 'Matthew',    lastName: 'Harris',    pronunciationUrl: pronunciationUrl, pronouns: 'he',  photoUrl: manPhotos[2],   website: 'linkedin.com/matthew',  data: {'college': 'Education',        'department': 'Education Administration'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'matthew@illinois.edu')]),
      Auth2PublicAccount(id: '26', profile: Auth2UserProfile(id: '26', firstName: 'Sandra',     lastName: 'Sanchez',   pronunciationUrl: pronunciationUrl, pronouns: 'she', photoUrl: womanPhotos[2], website: 'linkedin.com/sandra',   data: {'college': 'Public Safety',    'department': 'Police Training Institute'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'sandra@illinois.edu')]),
      Auth2PublicAccount(id: '27', profile: Auth2UserProfile(id: '27', firstName: 'Anthony',    lastName: 'Clark',     pronunciationUrl: pronunciationUrl, pronouns: 'he',  photoUrl: manPhotos[3],   website: 'linkedin.com/anthony',  data: {'college': 'Academic Affairs', 'department': 'Office of the Registrar'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'anthony@illinois.edu')]),
      Auth2PublicAccount(id: '28', profile: Auth2UserProfile(id: '28', firstName: 'Betty',      lastName: 'Ramirez',   pronunciationUrl: pronunciationUrl, pronouns: 'she', photoUrl: womanPhotos[3], website: 'linkedin.com/betty',    data: {'college': 'Student Affairs',  'department': 'Campus Recreation'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'betty@illinois.edu',)]),
      Auth2PublicAccount(id: '29', profile: Auth2UserProfile(id: '29', firstName: 'Mark',       lastName: 'Lewis',     pronunciationUrl: pronunciationUrl, pronouns: 'he',  photoUrl: manPhotos[3],   website: 'linkedin.com/mark',     data: {'college': 'Chancellor',       'department': 'News Bureau'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'mark@illinois.edu',)]),
      Auth2PublicAccount(id: '30', profile: Auth2UserProfile(id: '30', firstName: 'Ashley',     lastName: 'Robinson',  pronunciationUrl: pronunciationUrl, pronouns: 'she', photoUrl: womanPhotos[4], website: 'linkedin.com/ashley',   data: {'college': 'Armed Forces',     'department': 'Clinical Sciences'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'ashley@illinois.edu')]),
      Auth2PublicAccount(id: '31', profile: Auth2UserProfile(id: '31', firstName: 'Donald',     lastName: 'Walker',    pronunciationUrl: pronunciationUrl, pronouns: 'he',  photoUrl: manPhotos[0],   website: 'linkedin.com/donald',   data: {'college': 'Education',        'department': 'Special Education'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'donald@illinois.edu')]),
      Auth2PublicAccount(id: '32', profile: Auth2UserProfile(id: '32', firstName: 'Emily',      lastName: 'Allenb',    pronunciationUrl: pronunciationUrl, pronouns: 'she', photoUrl: womanPhotos[0], website: 'linkedin.com/emily',    data: {'college': 'Student Affairs',  'department': 'Counseling Center'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'emily@illinois.edu',)]),
      Auth2PublicAccount(id: '33', profile: Auth2UserProfile(id: '33', firstName: 'Steven',     lastName: 'King',      pronunciationUrl: pronunciationUrl, pronouns: 'he',  photoUrl: manPhotos[1],   website: 'linkedin.com/steven',   data: {'college': 'Academic Affairs', 'department': 'Principal\'s Scholars Pgm'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'steven@illinois.edu')]),
      Auth2PublicAccount(id: '34', profile: Auth2UserProfile(id: '34', firstName: 'Kimberly',   lastName: 'Wright',    pronunciationUrl: pronunciationUrl, pronouns: 'she', photoUrl: womanPhotos[1], website: 'linkedin.com/kimberly', data: {'college': 'Law',              'department': 'Law'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'kimberly@illinois.edu')]),
      Auth2PublicAccount(id: '35', profile: Auth2UserProfile(id: '35', firstName: 'Andrew',     lastName: 'Scott',     pronunciationUrl: pronunciationUrl, pronouns: 'he',  photoUrl: manPhotos[2],   website: 'linkedin.com/andrew',   data: {'college': 'Public Safety',    'department': 'Police Training Institute'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'andrew@illinois.edu')]),
      Auth2PublicAccount(id: '36', profile: Auth2UserProfile(id: '36', firstName: 'Margaret',   lastName: 'Torres',    pronunciationUrl: pronunciationUrl, pronouns: 'she', photoUrl: womanPhotos[2], website: 'linkedin.com/margaret', data: {'college': 'Armed Forces',     'department': 'Naval Science'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'margaret@illinois.edu')]),
      Auth2PublicAccount(id: '37', profile: Auth2UserProfile(id: '37', firstName: 'Paul',       lastName: 'Nguyen',    pronunciationUrl: pronunciationUrl, pronouns: 'he',  photoUrl: manPhotos[3],    website: 'linkedin.com/paul',    data: {'college': 'Education',        'department': 'Education Administration'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'paul@illinois.edu',)]),
      Auth2PublicAccount(id: '38', profile: Auth2UserProfile(id: '38', firstName: 'Donna',      lastName: 'Hill',      pronunciationUrl: pronunciationUrl, pronouns: 'she', photoUrl: womanPhotos[3], website: 'linkedin.com/dona',     data: {'college': 'Chancellor',       'department': 'News Bureau'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'dona@illinois.edu',)]),
      Auth2PublicAccount(id: '39', profile: Auth2UserProfile(id: '39', firstName: 'Joshua',     lastName: 'Flores',    pronunciationUrl: pronunciationUrl, pronouns: 'he',  photoUrl: manPhotos[3],   website: 'linkedin.com/joshua',   data: {'college': 'Academic Affairs', 'department': 'Provost/VCAA Admin'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'joshua@illinois.edu')]),
      Auth2PublicAccount(id: '40', profile: Auth2UserProfile(id: '40', firstName: 'Michelle',   lastName: 'Green',     pronunciationUrl: pronunciationUrl, pronouns: 'she', photoUrl: womanPhotos[4], website: 'linkedin.com/michelle', data: {'college': 'Law',              'department': 'Law Library'}), identifiers: [Auth2PublicAccountIdentifier(code: 'email', identifier: 'michelle@illinois.edu')]),
    ];
    sampleAccounts.sortByLastName();
    return sampleAccounts;
  }
