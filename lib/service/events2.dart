...
class Events2 with Service implements NotificationsListener {
  ...
  List<Event2> get _sampleEvents => <Event2>[
    Event2(id: '1',
      ...
      attendanceRequired: false, canceled: false, private: false, free: true, online: false,
    ...
    Event2(id: '2',
      ...
      attendanceRequired: true, canceled: false, private: false, free: true, online: false,
    ...
    Event2(id: '6',
      ...
      location: null,
      attendanceRequired: false, canceled: false, private: false, free: true, online: true,
