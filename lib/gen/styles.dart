...
class AppImages {
    static Widget get home => Styles().images?.getImage('home') ?? Container();
    static Widget get bug => Styles().images?.getImage('bug') ?? Container();
    static Widget get notification => Styles().images?.getImage('notification') ?? Container();
    static Widget get profile => Styles().images?.getImage('profile') ?? Container();
    static Widget get chevronUp => Styles().images?.getImage('chevron-up') ?? Container();
    static Widget get chevronDown => Styles().images?.getImage('chevron-down') ?? Container();
    static Widget get chevronLeft => Styles().images?.getImage('chevron-left') ?? Container();
    static Widget get chevronRight => Styles().images?.getImage('chevron-right') ?? Container();
    static Widget get close => Styles().images?.getImage('close') ?? Container();
    static Widget get retryMedium => Styles().images?.getImage('retry-medium') ?? Container();
}
